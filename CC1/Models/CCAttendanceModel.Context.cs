...
namespace CC1.Models
{
    ...
    public partial class CCAttendanceEntities : DbContext
    {
        public CCAttendanceEntities()
            : base("name=CCAttendanceEntities")
        {
        }
        ...
        public virtual DbSet<attendanceExpected> attendanceExpecteds { get; set; }
